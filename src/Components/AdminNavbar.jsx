...
const UpperBarContent = ({ onClose, ...rest }) => {
  ...
  return(
    ...
    <div  className='nav-header' style={{height: '60px', width: '18.2%'}}>
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 1000, backgroundColor: '#fff', height: '60px', width: '83%' }}className='header'>
