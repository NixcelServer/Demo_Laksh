 ...
 const [updateMode, setUpdateMode] = useState(false); 
  ...
  return (
    <div className="container" style={{ position:'relative',transform: 'translateY(-2px)',width:'800px', margintop:'10px',marginRight: '100px', marginLeft: '190px'}}>
      {/* <h2 className="text-center text-black bg-primary p-3 mb-5 rounded-pill" style={{position:'relative', margin: '10px 0',boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1), 0 6px 20px rgba(0, 0, 0, 0.15)', borderRadius: '20px', transform: 'translateY(-2px)',width:'700px',marginRight: '-100px', marginLeft: '150px',height:'60px',marginTop:'60px',backgroundImage: 'linear-gradient(to top, #09203f 0%, #537895 100%)' }}><h2 style={{marginleft:'-800px',color:'white '}}>Add New Product</h2></h2> */}
     
      <div style={{  marginRight: '-800px' ,marginTop:'40px' }}>
        <button 
          type="button" 
          style={{
